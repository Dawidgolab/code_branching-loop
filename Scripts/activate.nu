...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Dawid\IICE-PYTHON\CodeBranchingAndLoop'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Dawid\IICE-PYTHON\CodeBranchingAndLoop\Scripts\deactivate.nu'
